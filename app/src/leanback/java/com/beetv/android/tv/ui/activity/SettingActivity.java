...
import com.beetv.android.tv.databinding.ActivitySettingBinding;
...
import com.beetv.android.tv.impl.DohCallback;
...
import com.beetv.android.tv.ui.dialog.DohDialog;
...
public class SettingActivity extends BaseActivity implements ConfigCallback, SiteCallback, LiveCallback, DohCallback, AdminUrlCallback {
    ...
    private void onServerUrl(View view) {
        AdminUrlDialog.create(this).show();
    }
