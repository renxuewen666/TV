...
public class ExoUtil {
    ...
    public static CaptionStyleCompat getCaptionStyle() {
        if (Setting.isCaption()) {
            CaptioningManager cm = (CaptioningManager) App.get().getSystemService(Context.CAPTIONING_SERVICE);
            return CaptionStyleCompat.createFromCaptionStyle(cm.getUserStyle());
        }
